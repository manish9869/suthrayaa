          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-md mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Add some handcrafted goodies before checking out.
              </p>
                      ...
                      <div className="p-4 bg-peach/20 rounded-xl">
                        <div className="flex items-start gap-3">
                          <Checkbox
                            ...
                            onCheckedChange={handleCheckboxChange('giftWrap')}
                          />
                ...
                <AccordionItem value="shipping" className="border rounded-xl overflow-hidden">
                  <AccordionTrigger className="px-6 py-4 hover:no-underline" disabled={currentStepIndex < 1}>
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        'w-6 h-6 rounded-full flex items-center justify-center text-xs',
                        currentStepIndex >= 1 ? 'bg-primary text-primary-foreground' : 'bg-muted'
                      )}>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="font-medium flex items-center gap-2">
                                    {method.name}
                                    {isFree && (
                                      <span className="text-xs bg-mint px-2 py-0.5 rounded-full">FREE</span>
                                    )}
                                  </div>
                ...
                <AccordionItem value="payment" className="border rounded-xl overflow-hidden">
                  <AccordionTrigger className="px-6 py-4 hover:no-underline" disabled={currentStepIndex < 2}>
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        'w-6 h-6 rounded-full flex items-center justify-center text-xs',
                        currentStepIndex >= 2 ? 'bg-primary text-primary-foreground' : 'bg-muted'
                      )}>
                        3
                      </div>
