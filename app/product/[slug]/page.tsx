...
export default function ProductPage({ params }: ProductPageProps) {
  ...
  const handleAddToCart = () => {
    if (product.isCustomizable && product.customizationOptions?.allowText && !customText.trim()) {
      toast.error('Please enter your custom text')
      return
    }
    addItem(product, selectedColor, customText || undefined)
    openCart()
            ...
            <div className="lg:sticky lg:top-28 lg:self-start space-y-6">
              ...
              <div>
                <Label className="text-sm font-medium mb-3 block">
                  Select Color: <span className="text-muted-foreground capitalize">{selectedColor}</span>
                </Label>
                      ...
                      {selectedColor === color && (
                        <Check 
                          className={cn(
                            ...
                            ['#FFFFFF', '#F5F5DC', '#FFE5B5', '#FFB5BA'].includes(color.toUpperCase())
                              ? 'text-foreground'
                              : 'text-white'
                          )} 
                        />
              ...
              {/* Customization */}
              {product.isCustomizable && product.customizationOptions?.allowText && (
                <div className="p-4 bg-peach/30 rounded-xl">
                  ...
                  <Input
                    ...
                    value={customText}
                    onChange={(e) => setCustomText(e.target.value.slice(0, product.customizationOptions?.maxTextLength))}
                    className="bg-background"
                    maxLength={product.customizationOptions.maxTextLength}
                  />
                  <p className="text-xs text-muted-foreground mt-2">
                    {customText.length}/{product.customizationOptions.maxTextLength} characters
                  </p>
                    ...
                    <div className="mt-4 p-4 bg-background rounded-lg text-center">
                      ...
                      <div 
                        ...
                        style={{ 
                          ...
                          color: ['#FFFFFF', '#F5F5DC', '#FFE5B5', '#FFB5BA'].includes(selectedColor.toUpperCase()) 
                            ? '#1a365d' 
                            : '#FFFFFF'
                        }}
                      >
          ...
          <div className="mt-12">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  You can contact us within 24 hours of placing your order to make changes. 
                  After that, we may have already started crafting your piece.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>Is gift wrapping available?</AccordionTrigger>
                <AccordionContent>
                  Yes! We offer beautiful gift wrapping at checkout. You can also add a personalized 
                  note to make your gift extra special.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
